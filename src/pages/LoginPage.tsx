...
export function LoginPage({ onLogin }: Props) {
    ...
    return (
        <main className="relative min-h-screen overflow-hidden bg-canvas text-(--color-text-primary)">
            ...
            <div className="absolute left-[-12%] top-[-18%] h-130 w-130 rounded-full border-80 border-surface/10" />
            <div className="absolute bottom-[-22%] right-[-10%] h-140 w-140 rounded-full border border-surface/30" />
            ...
            <div className="relative grid min-h-screen lg:grid-cols-[0.95fr_1.05fr]">
                <section className="flex min-h-70 flex-col justify-between p-8 sm:p-10 lg:p-14">
                    <div className="flex items-center gap-4">
                        <div className="border-l-[6px] border-surface pl-4">
                            <div className="text-4xl font-bold leading-none tracking-wide text-(--color-text-primary)">SGTL</div>
                            <div className="mt-1 h-1 w-16 bg-surface" />
                        </div>
                        <div className="h-px flex-1 bg-border-strong" />
                    </div>

                    <div className="max-w-md">
                        <p className="text-sm font-semibold uppercase tracking-wide text-surface">Sistema de Gerenciamento de Transporte e Logística</p>
                    </div>
                </section>

                <section className="flex items-center px-6 py-10 sm:px-10 lg:px-16">
                    <form autoComplete="off" className="relative w-full max-w-md border-l border-border-strong bg-white/70 p-6 shadow-sm backdrop-blur-sm sm:p-8" onSubmit={handleSubmit}>
                        <div className="absolute -right-6 -top-6 h-12 w-12 border-r-4 border-t-4 border-surface" />
                        <div className="mb-7">
                            <p className="text-sm font-semibold uppercase tracking-wide text-surface">Acesso</p>
                            <h1 className="mt-2 text-3xl font-semibold text-(--color-text-primary)">Entrar</h1>
                        </div>
